...
public class FlowControlSample3 {
    private static final Logger LOG = LoggerFactory.getLogger(FlowControlSample3.class);

    public static void main(String[] args) {
        Flowable<Long> flowable = Flowable.interval(100, TimeUnit.MILLISECONDS);

        // TODO the flowable above emits a sequential number every 100 milliseconds,
        ...
        // etc.
        Flowable<List<Long>> result = Flowable.empty(); // TODO
