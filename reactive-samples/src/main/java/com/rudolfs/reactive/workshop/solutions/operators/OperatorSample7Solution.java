...
public class OperatorSample7Solution {
    private static final Logger LOG = LoggerFactory.getLogger(OperatorSample7Solution.class);
    ...
    public static void main(String[] args) {
        ...
        Flowable<String> result = Flowable.ambArray(stream1, stream2, stream3);
